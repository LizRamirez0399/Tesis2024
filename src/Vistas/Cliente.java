...
public final class Cliente extends javax.swing.JInternalFrame {
    ...
    Operaciones.OpeCliente dao = new Operaciones.OpeCliente();
    ...
    public void recuperarDatos() {
        ...
        if (fila >= 0) {
            ...
            ci.setIdciudad(c.getIdciudad());
            daoCiudad.consultarDatos(ci);

            txtCiudadCodigo.setText("" + c.getIdciudad());
    ...
    private void initComponents() {
        ...
        tablaDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Identificador", "Cliente", "Cedula", "Telefono", "Direccion", "Estado", "CiudadCodigo", "Ciudad"
            }
        ) {
            Class[] types = new Class [] {
        ...
        txtDireccion.setPrompt("Dirección de domicilio...");
                    ...
                    .addGroup(panelOperacionesLayout.createSequentialGroup()
                        ...
                        .addGroup(panelOperacionesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panelOperacionesLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtRuc, javax.swing.GroupLayout.DEFAULT_SIZE, 293, Short.MAX_VALUE))
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (res != 1) {
            ...
            if (operacion.equals("NUEVO")) {
                ...
                if (existe == true) {
                    JOptionPane.showMessageDialog(null, "LA CEDULA DE IDENTIDAD INGRESADA YA ESTA REGISTRADA EN LA BASE DE DATOS");
                } else {
                    guardar(operacion);
    ...
    private void txtDireccionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDireccionKeyTyped
        ...
        if (txtApellido.getText().length() == 250) {
            evt.consume();
        }
