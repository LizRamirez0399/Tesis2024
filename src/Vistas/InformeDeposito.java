 ...
 * @author Liz
 */
public final class InformeDeposito extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form InformeDeposito
     */
    public InformeDeposito() {
        this.setTitle("FrmInformeDeposito");
        initComponents();
    }

    private void generarInforme() {
        String msj = "";
        String ruta = "depositos.jasper";
    ...
    private void generarReporte(String ruta_archivo, Map parametros) {
        try {
            ...
            dialog.setTitle("INFORME DE DEPÓSITOS DEL SISTEMA");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Formulario de Informes de Depósitos");
        ...
        jLabel2.setText("Este programa, genera un informe listando todos los depósitos del sistema");
