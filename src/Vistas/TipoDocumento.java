 ...
 * @author Liz
 */
public final class TipoDocumento extends javax.swing.JInternalFrame {

    Modelos.ModTipoDocumento td = new Modelos.ModTipoDocumento();
    
    Operaciones.OpeTipoDocumento dao = new Operaciones.OpeTipoDocumento();
    ...
    public TipoDocumento() {
        this.setTitle("FrmTipoDocumento");
        initComponents();
        cargarTabla();
    }
    ...
    public void recuperarDatos() {
        ...
        if (fila >= 0) {
            ...
            td.setIdtipo(id);
            dao.consultarDatos(td);
            descripcion = td.getDescripcion();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Formulario de Tipos de Documentos");
